# contextmint.ai — site documentation

All website planning and deploy docs for the **contextmint-ai** repository live here. No dependency on the product monorepo `documentation/` tree.
